...
export const CardsFlipExercise = (
    {flipCards, generateMore, difficulty}: CardsFlipProps
) => {
    ...
    return (
        <>
            ...
            <div className="font-bold mt-3 mb-3 px-3">
                Exercise with flash cards:
            </div>
            <div className="space-y-1 text-sm md:text-lg mb-5 mx-3 p-5 bg-[linear-gradient(135deg,_#f5f7fa_0%,_#c3cfe2_100%)]
