...
export const EssayExercise = (
    {getIsLoading, generateMore, difficulty, languageToLearn, nativeLanguage, topic}: EssayExerciseProps
) => {
    ...
    return (
        <>
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 py-2 px-3 sm:py-3 sm:px-6 rounded-t-xl"
                ...
                <p className="text-blue-100 mt-1 text-sm sm:text-lg">Write a well-structured essay expressing your thoughts and arguments.</p>
            </div>
            <div className="space-y-3 px-3 sm:px-5 mt-3 font-medium">
                <label htmlFor="message"
                       className="font-bold text-gray-900">
                    Write an essay on suggested topic:
                </label>
                ...
                <textarea id="message" rows={6} value={currentEssay === null ? "" : currentEssay}
                ...
                {checkEssayResultGrade && checkEssayResultAiVersion && (
                    <div ref={anchorRef} className="my-6 space-y-5 text-sm sm:text-[16px] font-normal">
                        ...
                        <Separator.Root className="my-[15px] bg-gray-700 data-[orientation=horizontal]:h-px"/>
                        <div>
                            <p className="font-bold pb-1.5">How would AI write essay on this topic:</p>
                            <Markdown remarkPlugins={[remarkGfm]} rehypePlugins={[rehypeRaw]}>
                ...
                <div className="flex w-full justify-center sm:justify-end py-3">
                    <div className="flex gap-3 p-0">
                        <button type="button" onClick={handleCheckEssayClick}
