...
export const TextTranslation = (
    {text, getIsLoading, languageToLearn, nativeLanguage, generateMore, difficulty}: ExerciseSectionProps
) => {
    ...
    return (
        <>
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 py-2 px-3 sm:py-3 sm:px-6 rounded-t-xl"
                ...
                <p className="text-blue-100 mt-1 text-sm sm:text-lg">Translate text into your native language</p>
            </div>
            <div className="font-bold mt-3 mb-1.5 px-3">
                Read the text below and translate it:
            </div>
            <div className="space-y-5 px-3">
                ...
                <textarea id="message" rows={6} value={translationText === null ? "" : translationText}
                          onInput={(e) => setTranslationText(e.currentTarget.value?.trim())}
                ...
                <div className="flex w-full justify-center sm:justify-end">
                    <div className="flex gap-3 p-0">
                        <button type="button" onClick={handleCheckTranslationClick}
