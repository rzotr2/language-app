    ...
    return (
        <>
            <section className="container mx-auto mt-1 md:mt-8 flex flex-col md:flex-row items-center justify-center">
                <div className="text-white mx-4 md:mx-8 md:w-2/3 hidden md:block">
                    ...
                    <div className="mt-5">
                        <a href="/login" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4
            ...
            >
                <div className="container mx-auto flex flex-col items-center md:flex-row justify-center
                        flex-wrap md:flex-nowrap space-y-6">
